...
import { FileText, ArrowLeft, FolderOpen, Save, X, Link as LinkIcon, Code } from 'lucide-react';
    ...
    return (<div className="min-h-screen bg-gradient-to-b from-white via-blue-50/50 to-purple-50/50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <main className="max-w-3xl mx-auto px-6 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2 text-gray-900 dark:text-white">Create New Paper</h1>
            <p className="text-gray-600 dark:text-gray-300">Add a new research paper to track and analyze reviews with AI-powered analysis</p>
          </div>
            ...
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  <Link href="/repositories" className="flex-1">
