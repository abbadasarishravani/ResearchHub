            ...
            <Card className="md:col-span-1">
              ...
              <CardContent className="flex flex-col items-center">
                <div className="relative group cursor-pointer" onClick={handleAvatarClick}>
                  {formData.avatar ? (<img src={formData.avatar} alt="Profile" className="w-32 h-32 rounded-full object-cover border-4 border-accent/20 transition-opacity group-hover:opacity-75"/>) : (<div className="w-32 h-32 rounded-full bg-accent/10 flex items-center justify-center border-4 border-dashed border-accent/20 group-hover:bg-accent/20 transition-colors">
                ...
                <div className="mt-6 flex flex-col gap-2 w-full">
                  ...
                  {formData.avatar && (<Button variant="ghost" size="sm" className="text-destructive hover:text-destructive hover:bg-destructive/10" onClick={handleRemoveAvatar}>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input value={formData.name} onChange={(e) => setFormData(prev => ({ ...prev, name: e.target.value }))} placeholder="Your name"/>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input value={formData.email} disabled className="bg-secondary/50 cursor-not-allowed"/>
