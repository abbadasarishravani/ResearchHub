...
import { FileText, BookOpen, TrendingUp, Plus, ArrowRight, Clock, Zap, } from 'lucide-react';
...
export default function DashboardPage() {
    ...
    return (<div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Stats Grid */}
        <motion.div variants={containerVariants} initial="initial" animate="animate" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {[
            {
        ...
        ].map((stat, i) => (<motion.div key={i} variants={itemVariants}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Quick Actions */}
          <motion.div variants={itemVariants} initial="initial" animate="animate" transition={{ delay: 0.4 }} className="lg:col-span-1">
            <Card>
              <CardHeader>
          ...
          {/* Recent Activity */}
          <motion.div variants={itemVariants} initial="initial" animate="animate" transition={{ delay: 0.5 }} className="lg:col-span-2">
            <Card>
              <CardHeader>
        ...
        {/* Featured Papers */}
        <motion.div variants={itemVariants} initial="initial" animate="animate" transition={{ delay: 0.6 }} className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {papers.length === 0 ? (<div className="col-span-full py-12 text-center bg-card rounded-xl border border-dashed border-border flex flex-col items-center">
              ...
              </div>) : (papers.slice(0, 4).map((paper, i) => (<motion.div key={paper.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 + i * 0.05 }}>
