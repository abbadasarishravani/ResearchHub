...
import { FileText, ArrowLeft, Trash2, MessageSquare, CheckCircle, AlertCircle, Brain, Sparkles, FolderOpen, Calendar, User, Send, Code } from 'lucide-react';
...
export default function CodeReviewDetailPage() {
  ...
  const fetchData = async () => {
    try {
      const [reviewData, commentsData, suggestionsData] = await Promise.all([
        api.codeReviews.getOne(params.id as string),
        api.comments.getAll(params.id as string),
        api.suggestions.getAll(params.id as string),
      ]);
  ...
  const handleDelete = async () => {
    ...
    try {
      await api.codeReviews.delete(params.id as string);
      router.push('/papers');
    } catch (error) {
        ...
        >
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Badge
                variant={
                  codeReview.status === 'COMPLETED' ? 'default' :
                  codeReview.status === 'IN_PROGRESS' ? 'secondary' : 'outline'
                }
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {codeReview.aiAnalysis.issues?.map((issue: any, i: number) => (
                  ...
                  <div className="space-y-3">
                    {suggestions.map((suggestion, index) => (
                      <motion.div
                        ...
                        className="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-800"
                      >
