...
import { FileText, ArrowLeft, Sparkles, FolderOpen, X } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="title" placeholder="Review for paper" value={formData.title} onChange={(e) => setFormData({ ...formData, title: e.target.value })} required className="pl-10 h-12"/>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <select id="repository" value={formData.repositoryId} onChange={(e) => setFormData({ ...formData, repositoryId: e.target.value })} required className="w-full h-12 px-4 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                      <option value="">Select a paper</option>
                      {repositories.map((repo) => (<option key={repo.id} value={repo.id}>
                          {repo.name}
                        </option>))}
                    </select>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="description" placeholder="Describe what you want to review, specific areas of concern, or goals for this review" value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} className="min-h-24"/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="code" placeholder="Paste your paper content here for analysis..." value={formData.code} onChange={(e) => setFormData({ ...formData, code: e.target.value })} required className="min-h-48 font-mono text-sm"/>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <Button type="submit" className="flex-1 h-12 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 font-medium shadow-lg shadow-blue-500/25" disabled={loading}>
                    {loading ? 'Analyzing...' : (<>
