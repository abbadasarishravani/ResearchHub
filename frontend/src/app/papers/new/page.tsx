...
import { PaperCategory } from '@/types';
...
export default function NewPaperPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.title || !formData.abstract || !formData.content) return;
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    name="abstract"
                    rows={4}
                    placeholder="A brief summary of your research goals and findings..."
            ...
            <Card>
              ...
              <CardContent>
                <textarea
                  ...
                  name="content"
                  rows={15}
                  placeholder="Start writing your research paper content here..."
