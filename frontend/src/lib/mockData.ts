import { User, Paper, Review, Activity } from '@/types';
...
export const mockPapers: Paper[] = [
  {
    ...
    abstract:
      'This paper explores advanced transformer architectures specifically designed for processing and understanding lengthy documents. We introduce a novel attention mechanism that efficiently handles context windows exceeding 32K tokens while maintaining computational efficiency.',
...
This work opens new possibilities for processing large-scale documents in real-world applications.`,
  ...
  },
  {
    ...
    abstract:
      'We present a novel knowledge distillation approach for creating efficient vision-language models that maintain high performance while reducing computational overhead by 60%. Our method combines feature-level and response-level distillation.',
    content: `## Introduction
...
Tested on COCO, Flickr30K, and custom datasets. Achieved 95% of teacher model performance with 60% fewer parameters.`,
  ...
  },
  {
    ...
    abstract:
      'A comprehensive framework for implementing federated learning in production environments. We address communication efficiency, model convergence, and privacy guarantees across distributed datasets.',
    content: `## Overview
...
Successfully deployed across 50 edge devices with 92% communication reduction compared to standard federated learning approaches.`,
  ...
  },
  {
    ...
    abstract:
      'Novel GNN architecture for personalized recommendations. Our approach leverages user-item interaction graphs to generate highly relevant suggestions with improved cold-start performance.',
    content: `## Introduction
...
Tested on MovieLens-1M and Netflix datasets, outperforming existing methods by 18% in NDCG@10.`,
  ...
  },
  {
    ...
    abstract:
      'An interpretability framework for deep learning models in healthcare. We develop methods to explain model predictions in clinical contexts, improving trust and adoption among medical professionals.',
    content: `## Motivation
...
Validated with radiologists and cardiologists. Improved model trust scores from 62% to 89%.`,
  ...
  },
  {
    ...
    abstract:
      'Optimized YOLO-based architecture for mobile inference. Achieves 30fps on modern smartphones with 92% accuracy retention compared to desktop versions.',
    content: `## Challenge
...
export const mockReviews: Review[] = [
  {
    ...
    rating: 5,
    comments:
      'Excellent work on addressing the long document problem. The hierarchical attention mechanism is novel and well-executed. Clear improvement over existing methods. Minor suggestions: Consider discussing computational complexity in more detail.',
  ...
  },
  {
    ...
    rating: 4,
    comments:
      'Strong work on knowledge distillation for vision-language models. The two-stage approach is intuitive. Would like to see more analysis on what knowledge is preserved vs. lost during distillation.',
  ...
  },
  {
    ...
    rating: 5,
    comments:
      'Outstanding contribution to explainable AI in healthcare. The clinical validation is particularly impressive. This work will have significant real-world impact.',
    recommendation: 'accept',
